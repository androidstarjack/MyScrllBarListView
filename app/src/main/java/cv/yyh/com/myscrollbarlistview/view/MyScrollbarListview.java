package cv.yyh.com.myscrollbarlistview.view;
...
public class MyScrollbarListview  extends ListView implements AbsListView.OnScrollListener {
    ...
    public  interface OnPositionListener{
         void myPositionChanged(int position,Student student,MyScrollbarListview myScrollbarListView,View mScrollPanelView);
    }
